...
| Goal-reached notification | Scheduled at the goal instant while running, cancelled on pause/stop; banner shown even in the foreground | Unit tests; simulator |
